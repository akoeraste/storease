                    ...
                    <div class="mb-4">
                        ...
                        <form action="{{ route('profile.update') }}" method="POST">
                            ...
                            <div class="form-group" hidden>
                                ...
                                <input disabled class="form-control" type="email" name="email" required value="{{ auth()->user()->email }}">
                                @error('email')
                                <p class="text-danger">{{ $message }}</p>
                                @enderror
                            </div>
                            <div class="form-group">
                                <button type="submit" class="btn btn-success btn-lg">Update Profile <i class="bi bi-check"></i></button>
                            </div>
                        </form>
                    </div>
                </div>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="{{ route('profile.update.password') }}" method="POST">
                            ...
                            <div class="form-group">
                                <button type="submit" class="btn btn-success btn-lg">Update Password <i class="bi bi-check"></i></button>
                            </div>
                        </form>
                    </div>
                </div>
